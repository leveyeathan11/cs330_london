...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	float xOffset = 8*(xMousePos - gLastX);
	float yOffset = 8*(gLastY - yMousePos); // reversed since y-coordinates go from bottom to top
...
{
	// change camera speed
	g_pCamera->MovementSpeed += (2*yoffset);
...
void ViewManager::PrepareSceneView()
{
	...
	// define the current projection matrix based on view type
